...
//Cria o construtor da classe produtos
  Produtos(
      this.nome, this.qtde, this.preco, this.tipo_comunic, this.consumo_KW);
  void ligar() {
...
class Fritadeira extends Produtos {
  ...
  Fritadeira(nome, qtde, preco, tipo_comunic, consumo)
      : super(nome, qtde, preco, tipo_comunic, consumo);
// polimorfismo
  @override
  void ligar() {
...
class Arcondicionado extends Produtos {
  Arcondicionado(nome, qtde, preco, tipo_comunic, consumo)
      : super(nome, qtde, preco, tipo_comunic, consumo);
  @override
  void ligar() {
